...
import (
	...
	infraHealthcheck "go-clean-architecture-example/pkg/healthcheck/checks/infra"
	interHealthcheck "go-clean-architecture-example/pkg/healthcheck/checks/inter"
	"time"
)
